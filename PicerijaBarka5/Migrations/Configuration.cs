    ...
    internal sealed class Configuration : DbMigrationsConfiguration<PicerijaBarka5.Models.ApplicationDbContext>
    {
        ...
        protected override void Seed(PicerijaBarka5.Models.ApplicationDbContext context)
        {
            ...
            context.Ingredients.AddOrUpdate(x => x.IngredientId,
                ...
                new Models.Ingredient { IngredientId = new Guid("8fdbb921-0c88-4479-8eed-ab7609dda118"), Name = "Regular dough", IngredientType = Models.IngredientTypeEnum.IngredientType.Dough, QuantityPerSmallPizza = 250, Price = 30 },
                new Models.Ingredient { IngredientId = new Guid("8fdbb922-0c88-4479-8eed-ab7609dda118"), Name = "Brioche dough", IngredientType = Models.IngredientTypeEnum.IngredientType.Dough, QuantityPerSmallPizza = 250, Price = 30 },
                new Models.Ingredient { IngredientId = new Guid("8fdbb923-0c88-4479-8eed-ab7609dda118"), Name = "Pepperoni", IngredientType = Models.IngredientTypeEnum.IngredientType.Meat, QuantityPerSmallPizza = 100, Price = 100 },
                new Models.Ingredient { IngredientId = new Guid("8fdbb924-0c88-4479-8eed-ab7609dda118"), Name = "Salami", IngredientType = Models.IngredientTypeEnum.IngredientType.Meat, QuantityPerSmallPizza = 100, Price = 800 },
                new Models.Ingredient { IngredientId = new Guid("8fdbb925-0c88-4479-8eed-ab7609dda118"), Name = "Cheddar", IngredientType = Models.IngredientTypeEnum.IngredientType.Cheese, QuantityPerSmallPizza = 100, Price = 350 },
                new Models.Ingredient { IngredientId = new Guid("8fdbb926-0c88-4479-8eed-ab7609dda118"), Name = "Gouda", IngredientType = Models.IngredientTypeEnum.IngredientType.Cheese, QuantityPerSmallPizza = 100, Price = 320 },
                new Models.Ingredient { IngredientId = new Guid("8fdbb927-0c88-4479-8eed-ab7609dda118"), Name = "Ketchup", IngredientType = Models.IngredientTypeEnum.IngredientType.Sauce, QuantityPerSmallPizza = 20, Price = 150 },
                new Models.Ingredient { IngredientId = new Guid("8fdbb928-0c88-4479-8eed-ab7609dda118"), Name = "Mayonnaise", IngredientType = Models.IngredientTypeEnum.IngredientType.Sauce, QuantityPerSmallPizza = 20, Price = 100 },
                new Models.Ingredient { IngredientId = new Guid("8fdbb929-0c88-4479-8eed-ab7609dda118"), Name = "Peppers", IngredientType = Models.IngredientTypeEnum.IngredientType.Vegetable, QuantityPerSmallPizza = 100, Price = 60 },
                new Models.Ingredient { IngredientId = new Guid("8fdbb930-0c88-4479-8eed-ab7609dda118"), Name = "Pickles", IngredientType = Models.IngredientTypeEnum.IngredientType.Vegetable, QuantityPerSmallPizza = 100, Price = 140 });
